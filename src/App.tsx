                  ...
                  <div className="p-5 sm:p-8">
                    <div className="flex items-start gap-4 sm:gap-5 pb-5 border-b border-border/40">
                      ...
                      <div className="min-w-0">
                        <h2 className="text-2xl sm:text-3xl font-bold text-destructive leading-tight">{t("danger.title")}</h2>
                        <p className="text-muted-foreground mt-1 text-sm sm:text-base leading-relaxed">{t("danger.willIntro")}</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-5 sm:mt-6 grid gap-4 sm:gap-5">
                      <div className="bg-muted/30 p-4 sm:p-6 rounded-2xl border border-border/50">
                        <div className="grid gap-3">
                          {[
                            ...
                            <div key={i} className="flex items-start gap-3 text-sm sm:text-base text-foreground/80">
                            ...
                            {repoInfo.default_branch_candidates.length > 1 && (
                              <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                  <Button variant="outline" size="icon" className="h-12 w-12 rounded-xl border-input/50">
                      ...
                      <div className="rounded-2xl border border-destructive/15 bg-destructive/5 p-4 sm:p-6">
                        <div className="space-y-2 text-center">
                          <label className="text-sm font-medium block">
                            {t("danger.confirmPrefix")} <span className="text-destructive font-bold font-mono select-all bg-destructive/10 px-2 py-0.5 rounded">"{t("danger.confirmPhrase")}"</span> {t("danger.confirmSuffix")}
                          </label>
                          <Input
                            value={confirmText}
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-1">
                        <Button variant="outline" size="lg" className="flex-1 rounded-xl" onClick={() => setStep("analyze")}>
                          {t("danger.cancel")}
                        </Button>
                        <Button
                          variant="destructive"
